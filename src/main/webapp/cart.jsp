...
<link type="stylesheet" href="css/cart.css">
</head>
<body>
<nav>
<a href="/home">Home</a>&nbsp;&nbsp;
       ...
       <c:forEach items="${cart}" var="c">
        <li class="_grid shopping-cart--list-item">
          <div class="_column product-image">
            <img class="product-image--img" width="200px" height="200px" src="${c.product.getPhotosImagePath() }" alt="Item image" />
          </div>
          <div class="_column product-info">
            <h4 class="product-name">${c.product.pname}</h4>
            <p class="product-desc">${c.product.description}</p>
            <div class="price product-single-price">${c.product.price}</div>
          </div>
          <div class="_column product-modifiers" data-product-price="">
            <div class="_grid">
              <button class="_btn _column product-subtract">&minus;</button>
              <div class="_column product-qty">${c.quantity}</div>
              <button class="_btn _column product-plus">&plus;</button>
            </div>
            <button class="_btn entypo-trash product-remove"><a href="removefromcart/${c.id}">Remove</a></button>
